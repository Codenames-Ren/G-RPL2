                    ...
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <div class="committee-table-tools">
                                <label class="committee-search-wrap" for="committeeApprovalSearch">
                                    <input
                                        type="search"
                                ...
                                <span class="committee-search-count" data-approval-search-count>
                                    Semua Data
                                </span>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const searchInput = document.querySelector('[data-approval-search]');
        const searchCount = document.querySelector('[data-approval-search-count]');
        const approvalsBody = document.querySelector('[data-approvals-body]');
        const totalPending = document.querySelector('[data-total-pending]');
        ...
        function getDataRows() {
            ...
            return Array.from(approvalsBody.querySelectorAll('tr'))
                .filter(function (row) {
        ...
        function removeSearchEmptyRow() {
            ...
            const emptyRow = approvalsBody.querySelector('[data-search-empty-row]');
            if (emptyRow) {
                emptyRow.remove();
            }
        }
        ...
        function ensureSearchEmptyRow() {
            ...
            let emptyRow = approvalsBody.querySelector('[data-search-empty-row]');
            ...
            if (!emptyRow) {
                ...
                approvalsBody.appendChild(emptyRow);
            }
        }
        ...
        function updateTotalRows() {
            ...
            if (totalPending) {
                totalPending.textContent = dataRows.length;
            }
        }

        function filterApprovalTable() {
            if (!approvalsBody || !searchInput) {
                updateTotalRows();
                return;
            }
        ...
        if (searchInput) {
            searchInput.addEventListener('input', filterApprovalTable);
        }
        ...
        if (approvalsBody) {
            ...
            tableObserver.observe(approvalsBody, {
                childList: true,
                subtree: true,
                characterData: true
            });
