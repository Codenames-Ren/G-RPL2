    ...
    <section class="app-shell" data-protected-shell hidden>
        ...
        <div class="workspace">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 8px; margin-bottom: 8px;">
                <button class="button button-small" type="button" data-add-a1-course data-rpl-section="a1">+ Add A1 Course</button>
                <button class="button button-small" type="button" data-add-a2-experience data-rpl-section="a2">+ Add Learning Experience</button>
            </div>
            ...
            <div class="tab-content" data-tab-content="documents">
                <div class="form-grid">
                    <form data-upload-form class="form-grid">
                        ...
                        <button class="button" type="button" data-upload-document>Upload</button>
                    </form>
                </div>
                <div class="table-container">
                    <table class="data-table">
