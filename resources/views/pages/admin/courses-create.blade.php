...
@section('title', 'Create Course - G-RPL')
@section('page', 'courses-create')
...
@section('content')
    <section class="app-shell" data-protected-shell hidden>
        ...
        <div class="workspace course-create-workspace">
            <div class="course-create-hero">
                <div class="course-create-hero-content">
                    <div>
                        <p class="eyebrow course-create-eyebrow">Course Management</p>
                        <h2>Tambah Mata Kuliah</h2>
                        <p class="course-create-subtitle">
                            Buat data mata kuliah baru untuk kebutuhan rekognisi pembelajaran lampau.
                            Pastikan kode, nama, program studi, semester, SKS, dan tipe RPL sudah sesuai.
                        </p>
                    </div>

                    <div class="course-create-actions">
                        <span class="connection-pill course-create-status-pill" data-api-status>Connecting</span>
                ...
                <div class="course-create-info-grid">
                    <div class="course-create-info-card">
                        <span class="course-create-info-icon course-create-info-blue">
                    ...
                    <div class="course-create-info-card">
                        <span class="course-create-info-icon course-create-info-yellow">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div class="course-create-info-card">
                        <span class="course-create-info-icon course-create-info-green">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="course-create-panel">
                <div class="course-create-panel-head">
                    <div>
                ...
                <form class="form-grid course-create-form" data-course-form="create">
                    ...
                    <p class="form-message course-create-message course-create-full" data-form-message aria-live="polite"></p>
    ...
    <style>
        /*
        |--------------------------------------------------------------------------
        | CREATE COURSE PAGE - PREMIUM ADMIN STYLE
        |--------------------------------------------------------------------------
        */
        ...
        */
        ...
        .course-create-status-pill::before {
            content: "";
            width: 9px;
            height: 9px;
            flex: 0 0 9px;
        ...
        .course-create-status-pill.is-connected {
            color: #14532d;
        ...
        .course-create-status-pill.is-connected::before {
            background: #16a34a;
            box-shadow: 0 0 0 4px rgba(34, 197, 94, 0.18);
        }

        .connection-pill.is-connecting,
        .course-create-status-pill.is-connecting {
            color: #1d4ed8;
            background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%);
            border-color: #93c5fd;
        }
        ...
        .course-create-status-pill.is-connecting::before {
            background: #2563eb;
            box-shadow: 0 0 0 4px rgba(37, 99, 235, 0.15);
        }

        .connection-pill.is-error,
        .course-create-status-pill.is-error,
        .connection-pill.is-disconnected,
        .course-create-status-pill.is-disconnected {
            color: #991b1b;
        ...
        .course-create-status-pill.is-error::before,
        .connection-pill.is-disconnected::before,
        .course-create-status-pill.is-disconnected::before {
            background: #dc2626;
            box-shadow: 0 0 0 4px rgba(220, 38, 38, 0.16);
        }

        .course-create-back-btn {
            min-height: 42px;
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        .course-create-info-blue {
            color: #1565C0;
            background: rgba(21, 101, 192, 0.10);
            border: 1px solid rgba(21, 101, 192, 0.12);
        }

        .course-create-info-yellow {
            color: #b77905;
            background: rgba(249, 168, 37, 0.14);
            border: 1px solid rgba(249, 168, 37, 0.18);
        }

        .course-create-info-green {
            color: #16a34a;
            background: rgba(22, 163, 74, 0.10);
            border: 1px solid rgba(22, 163, 74, 0.12);
        }

        .course-create-info-card p {
            margin: 0 0 4px;
            color: #64748b;
            font-size: 0.74rem;
            font-weight: 900;
        ...
        .course-create-info-card strong {
            display: block;
            color: #0f172a;
            font-family: 'Sora', system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
            font-size: 1.04rem;
        ...
        .course-create-input-wrap,
        .course-create-select-wrap {
            position: relative;
            min-width: 0;
        }

        .course-create-input-wrap svg {
            position: absolute;
            top: 50%;
            left: 13px;
            width: 18px;
        ...
        .course-create-input-wrap input {
        ...
        .course-create-field select[multiple] {
            min-height: 145px;
            padding: 12px;
            line-height: 1.55;
        }
        ...
        .course-create-field input:focus,
        .course-create-field select:focus {
        ...
        .course-create-cancel-btn,
        .course-create-submit-btn {
            min-height: 46px;
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        .course-create-cancel-btn:hover {
            color: #0f172a;
            border-color: #cbd5e1;
        ...
        .course-create-submit-btn:hover {
            transform: translateY(-1px);
        ...
        .course-create-submit-btn:disabled {
            cursor: not-allowed;
            opacity: 0.65;
            transform: none;
            box-shadow: none;
